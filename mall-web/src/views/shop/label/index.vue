...
import {listLabel, getLabel, delLabel, addLabel, updateLabel} from "@/api/system/label.js";
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除商品标签编号为"' + _ids + '"的数据项？').then(function () {
...
function handleExport() {
  proxy.download('system/label/export', {
    ...queryParams.value
